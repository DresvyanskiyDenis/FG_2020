...
from Audio.Training.models import LSTM_model, CNN_1D_model
from Audio.Training.utils import generate_weights, load_data_csv, load_labels, plot_confusion_matrix, load_data_wav
...
def train_model_on_data(path_to_data, path_to_labels_train, path_to_labels_validation, path_to_output, window_size, window_step, class_weights_mode='my_realisation'):
    ...
    model = CNN_1D_model(input_shape, num_classes)
